...
echo 'variable "APP_INSTANCE_AMI" { default = "'${AMI_ID}'" }' > ../terraform/dev/service/git_oauth/ami.tf
echo 'variable "APP_INSTANCE_AMI" { default = "'${AMI_ID}'" }' > ../terraform/dev/service/rocket/ami.tf
